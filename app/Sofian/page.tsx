...
function Sofian() {
    ...
    const [color2, setColor2] = useState("#311B92");
    const [num3, setNum3] = useState();
    const [color3, setColor3] = useState("#D50000");
    const [num4, setNum4] = useState();
    const [color4, setColor4] = useState("#33691E");
        ...
        <>
            ...
            <h1 className="text-center mt-4 text-white">تصميم رقم</h1>
                ...
                <label className="text-white px-4 my-2">ألوان الرقم</label>
                    <div className="col">
                        <input type="number" className="form-control my-1" value={num1} onChange={(e) => setNum1(e.target.value)} />
                        <input type="color" className="form-control my-1" value={color1} onChange={(e) => setColor1(e.target.value)} />
                    </div>
                    <div className="col">
                        <input type="number" className="form-control my-1" value={num2} onChange={(e) => setNum2(e.target.value)} />
                        <input type="color" className="form-control my-1" value={color2} onChange={(e) => setColor2(e.target.value)} />
                    </div>
                    <div className="col">
                        <input type="number" className="form-control my-1" value={num3} onChange={(e) => setNum3(e.target.value)} />
                        <input type="color" className="form-control my-1" value={color3} onChange={(e) => setColor3(e.target.value)} />
                    </div>
                    <div className="col">
                        <input type="number" className="form-control my-1" value={num4} onChange={(e) => setNum4(e.target.value)} />
